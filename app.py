...
def upload_to_r2(local_file_path, r2_key):
    ...
    return f"{R2_PUBLIC_URL_BASE}/{r2_key}"
...
def download_instagram_reel(reel_url):
    ...
    try:
        ...
        r2_url = upload_to_r2(dest_path, r2_key)
        # Send r2_url to MongoDB
        send_to_mongodb(r2_url)
        # Remove the local file after upload
        os.remove(dest_path)
        return True, f"Saved reel and uploaded to {r2_url}"
